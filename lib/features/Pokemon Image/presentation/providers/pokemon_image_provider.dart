...
import 'package:architecture/features/pokemon/business/entities/pokemon_entity.dart';
...
class PokemonImageProvider extends ChangeNotifier {
  ...
  void eitherFailureOrPokemonImage(PokemonEntity pokemonEntity) async {
    ...
    final failureOrPokemonImage =
      ...
      pokemonImageParams: PokemonImageParams(name: name, imageUrl: imageUrl),
    );
